...
def plot_mean_latencies(mean_latencies, output_path='data_dump/mean_latencies.png'):
    prosumer_ids = sorted(mean_latencies.keys())  # Sort prosumer IDs
    latencies = [mean_latencies[prosumer] for prosumer in prosumer_ids]
...
def plot_latency_evolution(data, output_path='data_dump/latency_evolution.png'):
    plt.figure(figsize=(14, 8))
